...
# If the file has been already been downloaded ( I know it should have been deleted first so this shouldn't happen, but maybe you downloaded the same photo from the internet so it has the same name as before ), it won't download it nor delete it again and it will tell you which file.
